...
<!-- wp:pattern {"slug":"egnitech-one-child/another-section"} /-->
```
...
```html
<!-- wp:pattern {"slug":"egnitech-one-child/header-top-bar-variant-a"} /-->
```
 ...
 * Slug: egnitech-one-child/header-top-bar-variant-a
 * Categories: egnitech-one-child
 * Inserter: false
 */
?>
