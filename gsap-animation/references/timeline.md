...
Sequencing multiple tweens: `gsap.timeline()`, the position parameter, labels,
nesting, and playback control. For single tweens and eases see `SKILL.md`; for
scroll-driven timelines see `references/scrolltrigger.md`; for React see
`references/react.md`.
...
- ✅ Put ScrollTrigger on the timeline (or top-level tween), not on tweens inside a timeline — see `references/scrolltrigger.md`.
