...
Scroll-driven animations: triggering tweens/timelines on scroll, pinning
elements, scrubbing animation to scroll position. For tweens and timelines see
`SKILL.md` and `references/timeline.md`; for React cleanup see
`references/react.md`; for ScrollSmoother or scroll-to see
...
- [ScrollTrigger.scrollerProxy()](#scrolltriggerscrollerproxy)
- [Scrub](#scrub)
- [Pinning](#pinning)
- [Markers (Development)](#markers-development)
- [Timeline + ScrollTrigger](#timeline--scrolltrigger)
- [Horizontal scroll (containerAnimation)](#horizontal-scroll-containeranimation)
- [Refresh and Cleanup](#refresh-and-cleanup)
- [Official GSAP best practices](#official-gsap-best-practices)
- [Do Not](#do-not)
...
The timeline's progress is tied to scroll through the trigger's start/end range. See `references/timeline.md` for building the timeline itself.
...
In React, use the `useGSAP()` hook (@gsap/react NPM package) to ensure proper cleanup automatically, or manually kill in a cleanup (e.g. in useEffect return) when the component unmounts — see `references/react.md`.
